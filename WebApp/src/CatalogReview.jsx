...
const CatalogReview = ({ onNavigate }) => {
      ...
      <div className="header">
        <div className="header-content">
          ...
          <nav className="navigation">
            ...
            <button className="nav-link active">Catalogs</button>
            <button className="nav-link" onClick={() => onNavigate && onNavigate('multi-upload')}>Multi Search</button>
                  ...
                  <div key={product.id} className="table-row">
                    <div className="row-content">
                      ...
                      <div className="cell actions">
                        ...
                        <button 
                          className="action-btn add-to-quotation-btn"
